(() => {
  ...
  function renderOverview() {
    ...
    pairwiseOverviewApi.renderPairwiseOverview({
      ...
      emptyStateMessages: {
        signed: "No visible codon preference cells",
        similarity: "No visible taxon similarity cells",
      },
      emptyStateDetail: "Adjust the filters or choose a residue to populate the overview.",
      signedPreferenceStorageKey: SIGNED_PREFERENCE_SCALE_STORAGE_KEY,
    });
  }
