...
This is the minimal operator-facing guide for the current repository.

Use it for:
- building local runtime images
- starting the Django plus Postgres development stack
...
- `docker compose build web pipeline-acquisition pipeline-detection`
- `docker compose up web postgres`
